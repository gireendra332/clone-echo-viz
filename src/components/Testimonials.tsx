...
const Testimonials = () => {
  const testimonials = [
    {
      quote: "The voice cloning quality is unbelievable. My Hindi content now reaches Telugu audiences without losing my personal touch.",
      author: "Sarah Johnson",
      role: "Content Creator",
      originalLang: "Original (Hindi)",
      dubbedLang: "Dubbed (Telugu)",
      originalImage: "https://images.unsplash.com/photo-1615821430729-d3c98749eba4?w=400&h=300&fit=crop",
      dubbedImage: "https://images.unsplash.com/photo-1694009245674-9ad7f422d436?w=400&h=300&fit=crop"
    },
    {
            ...
            <Card key={index} className="p-8">
              <div className="flex flex-col md:flex-row items-center gap-8 mb-6">
                <div className="flex items-center gap-4 flex-1">
                  <img 
                    src={testimonial.originalImage} 
                    alt={testimonial.originalLang}
                ...
                <div className="flex items-center gap-4 flex-1">
                  <img 
                    src={testimonial.dubbedImage} 
                    alt={testimonial.dubbedLang}
                    className="w-32 h-24 object-cover rounded-lg"
                  />
                  <div className="text-sm font-medium text-muted-foreground">
